...
const FutureWeatherComponent = props =>{
   const customStyle = {
    ...
    return (
       <React.Fragment>
            <section style={customStyle} role="button" className="future-weather-container d-flex align-items-center justify-content-center flex-column brand-bg-white px-5 py-3 rounded-3 shadow-sm mx-2 my-2" onClick={props.onClick}>
                <section className="weather-wrapper d-flex flex-column align-items-center justify-content-center px-4">
