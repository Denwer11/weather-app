    ...
    return (
			<React.Fragment>
				<section
					style={customStyle}
					role="button"
					className="future-weather-container d-flex align-items-center justify-content-center flex-column brand-bg-white px-5 py-3 rounded-3 shadow-sm mx-2 my-2 border border-white border-5"
					onClick={props.onClick}>
					<section className="weather-wrapper d-flex flex-column align-items-center justify-content-center">
						<p className="brand-small-text-2  py-1 text-center m-0">
							{props.time}
						</p>
